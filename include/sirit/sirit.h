...
public:
    ...
    Id OpGroupNonUniformAll(Id result_type, spv::Scope scope, Id predicate);
    ...
    Id OpGroupNonUniformAny(Id result_type, spv::Scope scope, Id predicate);
    ...
    Id OpGroupNonUniformAllEqual(Id result_type, spv::Scope scope, Id value);
